// Import useSelector to read from the Redux store
...
function ProductList({ onHomeClick }) {
    ...
    // Get the array of items from the Redux cart state
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                {/* This span will display the total number of items in the cart */}
